...
class MetropolisSolver(Solver):
    ...
    def solve(self):
        ...
        while not solved:
            ...
            old_local_conflicts = self.g1.count_local_conflicts_i(node_i)

            # use sampler to get new color
            new_color = metropolis_sampler(self.g1, node_i, self.beta)

            new_local_conflicts = self.g1.count_local_conflicts_i(node_i)
